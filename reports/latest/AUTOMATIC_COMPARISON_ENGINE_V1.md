...
| P0 | NEEDS_ROUTE_TRACE | C2_WIDE_PATTERN_VS_ROUTE_TRACE | wide particle pattern may be secondary context rather than noise | relation_signal=0.6967013601350704 support=46 dst=hypothesis:T6_WIDE_SECONDARY_CONTEXT | route-neighbor trace / causal route controls | run route-neighbor trace for top all-head particles and wide non-particle0 particles |
...
| P1 | NEEDS_HELDOUT | C4_HEAD_RANK_STABILITY_VS_RUN_CHANGES | top all-head gates may be stable mechanism candidates | stability_score=0.9450 top_heads=['L1_ch112:128', 'L0_ch40:48', 'L2_ch224:256', 'L1_ch16:32', 'L0_ch48:56'] | more distinct snapshots / heldout files / controls | run heldout subsets and controls with HISTORY_COPY=1, then compare head ranks |
