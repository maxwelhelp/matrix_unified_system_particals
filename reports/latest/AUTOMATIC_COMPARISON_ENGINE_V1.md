...
| P1 | NEEDS_HELDOUT | C4_HEAD_RANK_STABILITY_VS_RUN_CHANGES | top all-head gates may be stable mechanism candidates | stability_score=0.9511 top_heads=['L1_ch112:128', 'L0_ch40:48', 'L2_ch224:256', 'L1_ch16:32', 'L0_ch48:56'] | more distinct snapshots / heldout files / controls | run heldout subsets and controls with HISTORY_COPY=1, then compare head ranks |
