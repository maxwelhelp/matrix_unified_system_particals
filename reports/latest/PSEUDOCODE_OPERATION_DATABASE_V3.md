...
| --- | --- | --- | --- | --- | --- | --- |
| L0_ch40:48 | context builder / relay away from direct core readout | Q1_core_readout, Q2_local_builders, Q4_trace_priority | label_Hcc:1, label_QCD:1, label_Hgg:1, label_Wqq:1 | 0.0000 | 0.0000 | RESIDUAL_SIGNAL_REMAINS |
...
| L1_ch0:16 | context builder / relay away from direct core readout | Q1_core_readout | label_Tbl:3, label_Hcc:1, label_QCD:1 | 0.0000 | 0.0000 | RESIDUAL_SIGNAL_REMAINS |
| L1_ch112:128 | context builder / relay away from direct core readout | Q1_core_readout, Q2_local_builders, Q3_residual_axis, Q4_trace_priority | label_Hcc:1, label_Wqq:1, label_Hgg:1, label_Tbl:1 | 0.2000 | 0.2000 | RESIDUAL_SIGNAL_REMAINS |
...
| L2_ch224:256 | route-aware late core readout | Q1_core_readout, Q3_residual_axis, Q4_trace_priority | label_Tbl:5 | 1.0000 | 0.8000 | RESIDUAL_SIGNAL_REMAINS |
| L2_ch0:32 | route-aware late core readout | Q1_core_readout, Q3_residual_axis, Q4_trace_priority | label_Tbl:5 | 1.0000 | 0.8000 | RESIDUAL_SIGNAL_REMAINS |
| L2_ch128:160 | route-aware late core readout | Q1_core_readout, Q3_residual_axis, Q4_trace_priority | label_Tbl:5 | 1.0000 | 1.0000 | RESIDUAL_SIGNAL_REMAINS |
| L2_ch32:64 | route-aware late core readout | Q1_core_readout | label_Tbl:4, label_Tbqq:1 | 0.8000 | 0.6000 | RESIDUAL_SIGNAL_REMAINS |
| L2_ch192:224 | late readout moderately core-aligned | Q1_core_readout | label_Tbqq:3, label_Tbl:2 | 0.4000 | 0.2000 | RESIDUAL_SIGNAL_REMAINS |
| L2_ch160:192 | route-aware late core readout | Q1_core_readout, Q3_residual_axis | label_Tbl:4, label_Tbqq:1 | 0.8000 | 0.6000 | RESIDUAL_SIGNAL_REMAINS |
| L2_ch64:96 | route-aware late core readout | Q1_core_readout, Q3_residual_axis, Q4_trace_priority | label_Tbl:3, label_Hqql:2 | 1.0000 | 1.0000 | RESIDUAL_SIGNAL_REMAINS |
...
Top event labels: label_Hcc:1, label_QCD:1, label_Hgg:1, label_Wqq:1
...
for particle i:
    ...
    # role: context builder / relay away from direct core readout; classes: label_Hcc:1, label_QCD:1, label_Hgg:1, label_Wqq:1
```
...
Top event labels: label_Tbl:3, label_Hcc:1, label_QCD:1
...
for particle i:
    ...
    # role: context builder / relay away from direct core readout; top_event_particles_core_rate=0.0000
```
...
Inner trace: top_event_particle0=0.2000, top_event_leading=0.2000, knn_has_particle0=0.2000, knn_has_leading=0.2000

Top event labels: label_Hcc:1, label_Wqq:1, label_Hgg:1, label_Tbl:1
...
for particle i:
    ...
    route_context = mix_core_and_secondary(l0_context)
    write_L1_context(route_context)
    # role: context builder / relay away from direct core readout; top_event_particles_core_rate=0.2000
```
...
Inner trace: top_event_particle0=1.0000, top_event_leading=1.0000, knn_has_particle0=0.8000, knn_has_leading=0.8000

Top event labels: label_Tbl:5
...
for event:
    ...
    if route_matches_core(top_particle_rate=1.0000, knn_has_core=0.8000):
        logits += project_class_evidence(evidence)
    # role: route-aware late core readout; classes: label_Tbl:5
```
...
### L2_ch0:32 — route-aware late core readout
...
Inner trace: top_event_particle0=1.0000, top_event_leading=1.0000, knn_has_particle0=1.0000, knn_has_leading=1.0000
...
for event:
    ...
    context = read_L1_context(top_particle, neighbors)
    evidence = aggregate_context(context)
    if route_matches_core(top_particle_rate=1.0000, knn_has_core=1.0000):
        logits += project_class_evidence(evidence)
    # role: route-aware late core readout; classes: label_Tbl:5
```
...
Inner trace: top_event_particle0=0.8000, top_event_leading=0.8000, knn_has_particle0=0.6000, knn_has_leading=0.6000

Top event labels: label_Tbl:4, label_Tbqq:1
...
for event:
    ...
    context = read_L1_context(top_particle, neighbors)
    evidence = aggregate_context(context)
    if route_matches_core(top_particle_rate=0.8000, knn_has_core=0.6000):
        logits += project_class_evidence(evidence)
    # role: route-aware late core readout; classes: label_Tbl:4, label_Tbqq:1
```
...
Inner trace: top_event_particle0=0.4000, top_event_leading=0.4000, knn_has_particle0=0.2000, knn_has_leading=0.2000

Top event labels: label_Tbqq:3, label_Tbl:2
...
for event:
    ...
    context = read_L1_context(top_particle, neighbors)
    evidence = aggregate_context(context)
    if route_matches_core(top_particle_rate=0.4000, knn_has_core=0.2000):
        logits += project_class_evidence(evidence)
    # role: late readout moderately core-aligned; classes: label_Tbqq:3, label_Tbl:2
```
...
Top event labels: label_Tbl:3, label_Hqql:2
...
for event:
    ...
    if route_matches_core(top_particle_rate=1.0000, knn_has_core=1.0000):
        logits += project_class_evidence(evidence)
    # role: route-aware late core readout; classes: label_Tbl:3, label_Hqql:2
```
