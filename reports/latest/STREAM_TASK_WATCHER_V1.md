...
| P0 | HIGH | 0.9511 | T2_HEAD_RANK_STABILITY | Do the same heads stay important across snapshots? | Keep tracking; if unstable, split by class/sample size and run heldout stability. |
...
| P1 | LOW | 0.1500 | T6_WIDE_SECONDARY_CONTEXT | Besides particle0/core, is there stable wide/secondary particle context? | Run route-neighbor trace for top all-head particles and wide secondary particles. |
...
- **T2_HEAD_RANK_STABILITY** is `HIGH` (0.9511). Next: Keep tracking; if unstable, split by class/sample size and run heldout stability.
