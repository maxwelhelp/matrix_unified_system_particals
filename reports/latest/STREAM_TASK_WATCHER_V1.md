...
| P0 | HIGH | 0.9455 | T2_HEAD_RANK_STABILITY | Do the same heads stay important across snapshots? | Keep tracking; if unstable, split by class/sample size and run heldout stability. |
...
- **T2_HEAD_RANK_STABILITY** is `HIGH` (0.9455). Next: Keep tracking; if unstable, split by class/sample size and run heldout stability.
