...
- Route-width hypothesis L0: label_Wqq has compact neighbor routing (0.1331), label_Tbqq has wide routing (0.2521).
- Route-width hypothesis L1: label_Wqq has compact neighbor routing (0.1586), label_Tbqq has wide routing (0.2775).
- Route-width hypothesis L2: label_Wqq has compact neighbor routing (0.1614), label_Tbqq has wide routing (0.2863).
- Route-width hypothesis L0: label_Wqq has compact neighbor routing (0.1331), label_Tbqq has wide routing (0.2521).
- Route-width hypothesis L1: label_Wqq has compact neighbor routing (0.1586), label_Tbqq has wide routing (0.2775).
- Route-width hypothesis L2: label_Wqq has compact neighbor routing (0.1614), label_Tbqq has wide routing (0.2863).
...
- Leading-particle control: top_pt ablation accuracy=0.462 vs random=0.740; leading particles are not interchangeable with random particles.
...
| --- | --- | --- | --- | --- | --- |
| label_Wqq_vs_label_Zqq | -0.0236 | -0.0288 | -0.0296 | -5.0172 | -4.1250 |
| label_Tbqq_vs_label_Tbl | 0.0375 | 0.0418 | 0.0444 | 46.8804 | 22.3047 |
| label_Hbb_vs_label_Hcc | -0.0082 | -0.0074 | -0.0082 | -14.0860 | 3.4766 |
| label_Hbb_vs_label_Hgg | 0.0165 | 0.0180 | 0.0195 | -4.2105 | -15.9141 |
| label_H4q_vs_label_Hqql | 0.0128 | 0.0116 | 0.0109 | 30.7529 | 21.3359 |
| label_QCD_vs_label_Wqq | 0.0345 | 0.0391 | 0.0432 | -3.4937 | 8.1875 |
| label_QCD_vs_label_Tbqq | -0.0845 | -0.0798 | -0.0817 | -87.5707 | -11.3594 |
